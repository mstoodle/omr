...
OMR::ResolvedMethod::ResolvedMethod(const char      * fileName,
...
TR_IlGenerator *
OMR::ResolvedMethod::getIlGenerator(TR::IlGeneratorMethodDetails * details,
...
OMR::ResolvedMethod::getParameterTypeSignature(int32_t parmIndex)
   {
   assert(parmIndex < _numParms);

   // this const-ness should really be fixed, but because this function is virtual and is probably overridden by all OMR projects, so needs coordination
   return const_cast<char *>(signatureNameForType[_parmTypes[parmIndex].getDataType()]);
   }

const char *
OMR::ResolvedMethod::signatureNameForType[TR::NumOMRTypes] =
   {
   "V",  // NoType
   "B",  // Int8
   "C",  // Int16
...
const char *
OMR::ResolvedMethod::signatureNameForVectorType[TR::NumVectorElementTypes] =
   {
   "V1", // VectorInt8
   "V2", // VectorInt16
   "V4", // VectorInt32
...
const char *
OMR::ResolvedMethod::signatureNameForMaskType[TR::NumVectorElementTypes] =
   {
   "M1", // MaskInt8
   "M2", // MaskInt16
   "M4", // MaskInt32
