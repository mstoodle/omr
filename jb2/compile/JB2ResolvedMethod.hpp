...
#ifndef JB2RESOLVEDMETHOD_INCL
#define JB2RESOLVEDMETHOD_INCL
...
public:
   ...
   TR_IlGenerator *getIlGenerator(TR::IlGeneratorMethodDetails * details, TR::ResolvedMethodSymbol *methodSymbol, TR_FrontEnd *fe, TR::SymbolReferenceTable *symRefTab);
   ...
   virtual char                * nameChars()                                { return const_cast<char *>(_name); }
...
#endif // !defined(JB2RESOLVEDMETHOD_INCL)
