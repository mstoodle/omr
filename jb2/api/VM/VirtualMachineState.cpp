...
StateKind VirtualMachineState::STATEKIND=KindService::NoKind;
bool VirtualMachineState::kindRegistered = false;
...
const StateKind
VirtualMachineState::getStateClassKind() {
    if (!kindRegistered) {
        STATEKIND = KindService::NoKind;
        kindRegistered = true;
    }
    return STATEKIND;
}
