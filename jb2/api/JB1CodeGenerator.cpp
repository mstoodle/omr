...
INIT_JBALLOC_REUSECAT(JB1CodeGenerator, CodeGeneration)

JB1CodeGenerator::JB1CodeGenerator(Allocator *a, Compiler *compiler)
    : Visitor(a, compiler, "jb1cg")
    , _j1mb(NULL) {
    setTraceEnabled(false);
}

JB1CodeGenerator::~JB1CodeGenerator() {
